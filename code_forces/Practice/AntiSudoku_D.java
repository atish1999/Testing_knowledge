...
public class AntiSudoku_D implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new AntiSudoku_D(), "Main", 1 << 26).start();
	}
...
//		we can replace any single character 
				System.out.println(l.replace('7', '1'));
			}
