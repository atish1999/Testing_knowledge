...
public class Strange_partition_A implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Strange_partition_A(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			...
			for(int i=0; i<n; i++) {
				long a=fr.nextLong();
				min+=a;
				long b=CP.ceil_div(a, x);
				max+=b;
			}
			min=CP.ceil_div(min, x);
