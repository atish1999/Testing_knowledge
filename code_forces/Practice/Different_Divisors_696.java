...
public class Different_Divisors_696 implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Different_Divisors_696(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		for(int i=2; i<prime.length; i++) if(prime[i]) l.add((long)i);
		while (t-- > 0) {
			long d=fr.nextLong();
			long x=1+d;
			long f=0,s=0;
