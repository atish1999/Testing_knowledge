...
public class Berland_Crossward implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Berland_Crossward(), "Main", 1 << 26).start();
	}

	void solve() {
		int n = fr.nextInt();
		int u=fr.nextInt(),r=fr.nextInt(),d=fr.nextInt(),l=fr.nextInt();
