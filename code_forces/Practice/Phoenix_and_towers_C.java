...
public class Phoenix_and_towers_C implements Runnable {
...
//	static final FastWriter out = new FastWriter("./output.txt");
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Phoenix_and_towers_C(), "Main", 1 << 26).start();
	}
	...
	void solve() {
		int n = fr.nextInt(), m = fr.nextInt(), diff = fr.nextInt();
