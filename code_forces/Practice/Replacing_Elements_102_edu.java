...
public class Replacing_Elements_102_edu implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Replacing_Elements_102_edu(), "Main", 1 << 26).start();
	}
