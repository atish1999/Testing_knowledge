...
public class Labour_of_Heracles_13_GRAPH implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Labour_of_Heracles_13_GRAPH(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			int n = fr.nextInt();
			int deg[]=new int[n+1],w[]=new int[n+1];
			long sum=0;
			for(int i=1; i<=n; i++) {
				w[i]=fr.nextInt();
				sum+=w[i];
