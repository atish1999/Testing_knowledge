...
public class K_divisible_Sum_103 implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new K_divisible_Sum_103(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			double n=fr.nextDouble(),k=fr.nextDouble();
			if(n>k) {
				System.out.println(n%k==0?1:2);
			}else {
				System.out.println(CP.ceil_div(k, n));
			}
		}
	...
	static class CP {
		...
		static long ceil_div(double n, double k) { // a numerator b denominator
			return (long) ((n + k - 1) / k);
		}
