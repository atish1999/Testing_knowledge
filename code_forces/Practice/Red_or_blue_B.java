...
public class Red_or_blue_B implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Red_or_blue_B(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			...
			long s1=0,ma1=0;
/*
      calclate maximum prefix sum from 1st array and maximum prefix sum from 2nd array
      and answer would be the sum of these 2 maximum prefix sum
      x y z {x= max prefix sum from r, y=max prefix sum from b, z=rest elements }
 */
			for(int i=0; i<n; i++) {
				r.add(fr.nextInt());
				s1+=r.get(i);
