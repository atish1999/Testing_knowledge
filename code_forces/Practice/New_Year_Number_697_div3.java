...
public class New_Year_Number_697_div3 implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new New_Year_Number_697_div3(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		err.println("Time taken: " + (end - start) / 1000000 + " ms");
	}
