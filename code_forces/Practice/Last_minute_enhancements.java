...
public class Last_minute_enhancements implements Runnable {
	...
	static class FastReader {
		...
		ArrayList<Integer> input_vector(int size){
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Last_minute_enhancements(), "Main", 1 << 26).start();
	}
