...
public class No_More_Inversions_102_edu implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new No_More_Inversions_102_edu(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			...
			for(int i=1; i<k-(n-k);  i++) System.out.print(i+" ");
			for(int i=k; i>=(2*k-n); i--) System.out.print(i+" ");
