...
public class Space_Navigation_699 implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Space_Navigation_699(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			int x1 = fr.nextInt(),y1=fr.nextInt();
			char p[]=fr.next().toCharArray();
			int l=0,u=0,d=0,r=0;
