...
public class Puzzle_From_the_Future implements Runnable {
	...
	public static void main(String[] args) throws java.lang.Exception {
		new Thread(null, new Puzzle_From_the_Future(), "Main", 1 << 26).start();
	}
	...
	public void run() {
		...
		while (t-- > 0) {
			int n=fr.nextInt();
			char[] o=fr.next().toCharArray();
			char s[]="1".repeat(n).toCharArray();
			String c = "";
			for(int i=0; i<n; i++) {
				int x=(o[i]-48)+(s[i]-48);
				c+=(char)(x+48);
