...
import java.util.*;
import java.io.*;
public class Magic_Powder_D1500 {
...
//	I can make minimum 0 cookies and maximum (sum2/sum1) cookies.
		...
		while(l<=r) {
//	 so we are just checking whether mid number of cookies can be baked or not.
			long m=(l+r)>>>1;
			long cnt=0;
			for(int i=0; i<n; i++) {
				long required=a[i]*m;
//		cnt means how much gram ingredients I need extra.i.e. how many grams
//		of magic powder we need extra.
				cnt+=Math.max(0, required-b[i]);
			}
